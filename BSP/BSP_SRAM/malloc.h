...
/*
 * ALIENTEK's allocator expects compiler alignment helpers to be available.
 * In this project, make the dependency explicit and provide a safe fallback
 * so the file can compile under Keil AC5/AC6 and GCC-compatible compilers.
 */
#ifndef __ALIGNED
  #if defined(__CC_ARM)
