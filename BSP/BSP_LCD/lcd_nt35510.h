 ...
 * 屏幕分辨率
 * ============================================================ */
#define NT35510_PANEL_WIDTH   480
#define NT35510_PANEL_HEIGHT  800

/*
 * One-switch display orientation:
 *   NT35510_DIR_PORTRAIT       -> 480 x 800, normal portrait
 *   NT35510_DIR_LANDSCAPE      -> 800 x 480, normal landscape
 *   NT35510_DIR_PORTRAIT_REV   -> 480 x 800, reverse portrait
 *   NT35510_DIR_LANDSCAPE_REV  -> 800 x 480, reverse landscape
 *
 * Change NT35510_DIRECTION only.
 */
#define NT35510_DIR_PORTRAIT       0
#define NT35510_DIR_LANDSCAPE      1
#define NT35510_DIR_PORTRAIT_REV   2
#define NT35510_DIR_LANDSCAPE_REV  3

#ifndef NT35510_DIRECTION
  #define NT35510_DIRECTION NT35510_DIR_LANDSCAPE_REV
#endif

#if (NT35510_DIRECTION == NT35510_DIR_PORTRAIT)
  #define NT35510_MADCTL  0x00
  #define NT35510_WIDTH   NT35510_PANEL_WIDTH
  #define NT35510_HEIGHT  NT35510_PANEL_HEIGHT
#elif (NT35510_DIRECTION == NT35510_DIR_LANDSCAPE)
  /*
   * Normal landscape:
   * keep GUI logical (0, 0) at the physical top-left corner.
   */
  #define NT35510_MADCTL  0xA0
  #define NT35510_WIDTH   NT35510_PANEL_HEIGHT
  #define NT35510_HEIGHT  NT35510_PANEL_WIDTH
#elif (NT35510_DIRECTION == NT35510_DIR_PORTRAIT_REV)
  #define NT35510_MADCTL  0xC0
  #define NT35510_WIDTH   NT35510_PANEL_WIDTH
  #define NT35510_HEIGHT  NT35510_PANEL_HEIGHT
#elif (NT35510_DIRECTION == NT35510_DIR_LANDSCAPE_REV)
  /*
   * Reverse landscape:
   * previous setting used in this project, kept for easy fallback.
   */
  #define NT35510_MADCTL  0x60
  #define NT35510_WIDTH   NT35510_PANEL_HEIGHT
  #define NT35510_HEIGHT  NT35510_PANEL_WIDTH
#else
  #error Invalid NT35510_DIRECTION configuration
#endif
