...
#define DSOSCREEN_ENDX      1039     /* 波形显示的X结束位置 */
#define DSOSCREEN_ENDY      639     /* 波形显示的Y结束位置 */
#define DSOSCREEN_LENGTH    1000     /* 波形显示的Y结束位置 */
...
#define GUI_CH1Color  GUI_YELLOW
#define GUI_CH2Color  GUI_GREEN

#define GUI_CH3Color  0xAFdfB6
#define GUI_CH4Color  0x0080ff

#define GUI_CH5Color  0xbc6aff
#define GUI_CH6Color  0x78c9df

#define GUI_CH7Color  0x4e57d9
#define GUI_CH8Color  GUI_CYAN

extern const GUI_COLOR CHXColor[8];

#define GUI_FREQ  0xABdd71
extern GUI_CONST_STORAGE GUI_FONT GUI_Fontkaifont;
/*
*********************************************************************************************************
*	                                  变量
*********************************************************************************************************
...
typedef struct
{
	...
	uint16_t    usWaveBuf[1000];        /* 波形刷新缓冲，一次刷新需要600个点 */
...
extern GUI_CONST_STORAGE GUI_BITMAP bmframebk;

extern const unsigned char _acframebk1[30024UL + 1];
/*
*********************************************************************************************************
*	                                  供外部文件调用的函数
*********************************************************************************************************
