...
void DSO_DrawCursorV(void) 
{
	...
	/* 第2步：绘制游标数据显示窗口********************************************************/
	GUI_SetColor(GUI_BLACK);
	GUI_FillRoundedRect(500+390, 55, 635+390, 135, 4);
	GUI_SetColor(0x888888);
	GUI_SetPenSize(2);
	GUI_AA_DrawRoundedRect(499+390, 54, 636+390, 136, 10);
//	GUI_DrawRoundedRect( 499+400, 54, 636+400, 136, 4);
					 
	GUI_SetColor(0x0040f0);
	GUI_FillRoundedRect(75 + 433+390 , 47 + 15, 86 + 433+390, 62 + 15, 3);				 
	GUI_FillRoundedRect(75 + 433 +390, 45 + 45, 86 + 433+390, 60 + 45, 3);
					 
	GUI_SetColor(GUI_BLACK);
	GUI_SetFont(&GUI_Font20_1);
	GUI_SetTextMode(GUI_TEXTMODE_TRANS);					
	GUI_DispCharAt('a', 509+390, 59);
	GUI_DispCharAt('b', 509+390, 88);

	GUI_SetColor(GUI_YELLOW);
	GUI_SetFont(&GUI_Font16_1);
	GUI_DispCharAt('#', 513+390, 115);
	...
	/* 显示竖线A数值 */
	GUI_DispStringAt(buf, 523+390, 63);
	...
	/* 显示竖线B数值 */
	GUI_DispStringAt(buf, 523+390, 91);
