...
void DSO_DrawCursorH(void) 
{
	...
	/* 第2步：绘制游标数据显示窗口********************************************************/
	GUI_SetColor(GUI_BLACK);
	GUI_FillRoundedRect(500+400, 55, 635+400, 135, 4);
	GUI_SetColor(0x888888);
	GUI_SetPenSize(2);
	GUI_AA_DrawRoundedRect(499+400, 54, 636+400, 136, 10);
//	GUI_DrawRoundedRect( 499+400, 54, 636+400, 136, 4);
						 
	GUI_SetColor(0x0040f0);
	GUI_FillRoundedRect(75 + 433+400 , 47 + 15, 86 + 433+400, 62 + 15, 3);				 
	GUI_FillRoundedRect(75 + 433+400 , 45 + 45, 86 + 433+400, 60 + 45, 3);
						 
	GUI_SetColor(GUI_BLACK);
	GUI_SetFont(&GUI_Font20_1);
	GUI_SetTextMode(GUI_TEXTMODE_TRANS);					
	GUI_DispCharAt('a', 509+400, 59);
	GUI_DispCharAt('b', 509+400, 88);
	
	GUI_SetColor(GUI_YELLOW);
	GUI_SetFont(&GUI_Font16_1);
	GUI_DispCharAt('#', 511+400, 115);
	...
	GUI_DispStringAt(buf, 523+400, 63);
	...
	GUI_DispStringAt(buf, 523+400, 91);
