...
{ 
    { WINDOW_CreateIndirect,     "",       0,            712,  	648,  130,  66, 0},
//	{ TEXT_CreateIndirect,      "CPU: 00.00%",      ID_TEXT_0,  35,   2, 100, 16, 0, 0},
	{ TEXT_CreateIndirect,      "CH1: DC 1:1",  	ID_TEXT_0,  35,  0, 100, 16, 0, 0},
	{ TEXT_CreateIndirect,      "CH2: DC 1:1",    	ID_TEXT_1,  35,  16, 100, 16, 0, 0},
	{ TEXT_CreateIndirect,      "Input1: 0-3.3V",   ID_TEXT_2,  35,  32, 100, 16, 0, 0},
	{ TEXT_CreateIndirect,      "Input2: 0-3.3V",   ID_TEXT_3,  35,  48, 100, 16, 0, 0},
};
...
static void PaintDialogSysInfo(WM_MESSAGE * pMsg)
{
	...
	GUI_AA_FillRoundedRect(0, 0, 129, 65, 10);
	
	/* 绘制抗锯齿圆角矩形 */
	GUI_SetColor(0XEBCD9E);
	GUI_SetPenSize(2);
	GUI_AA_DrawRoundedRect(0, 0, 129, 65, 10);
...
static void InitDialogSysInfo(WM_MESSAGE * pMsg)
{
	...
	TEXT_SetTextColor(WM_GetDialogItem(hWin, ID_TEXT_2), GUI_YELLOW);
