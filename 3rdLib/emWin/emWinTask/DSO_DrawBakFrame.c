...
//  	GUI_DrawPixel(x1, y0 + 1 + (200));
	...
	//x0 - 1 + 250
	GUI_DrawPixel(x0 + 499, y1);
	//x0 + 1 + 250		
	GUI_DrawPixel(x0 + 501,y1);
	...
	{	
		...
		//y0 - 1 + 250
		//b = y0 + 249;
		GUI_DrawPixel(x0 + x * 10, y0 + 299);
		
		//a = x0 + x * 10;
		//y0 + 1 + 250
		//b = y0 + 251;		
 		GUI_DrawPixel(x0 + x * 10, y0 + 301);
	}
	 
 	GUI_DrawPixel(x1, y0 + 299);
  	GUI_DrawPixel(x1, y0 + 301);
}
